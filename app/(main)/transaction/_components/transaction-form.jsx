 ...
 * @param {Object} props
 * @param {Array} props.accounts - List of account objects with id, name, balance
...
export function AddTransactionForm({
    ...
    defaultValues:
      editMode && initialData
        ? {
            ...
            // Assumes category is stored as the category id
  ...
  // defaultCategories now includes categories for all transaction types.
